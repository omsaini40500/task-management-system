...
export default function Settings() {
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      const saved = await api.patch<Department>(`/departments/${editDept.id}`, {
        name,
      })
        ...
        <div className="w-52 flex-shrink-0 space-y-0.5">
          {settingsTabs.map((tab) => (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-smooth text-left ${
        ...
        <div className="flex-1 min-w-0">
          ...
          {activeTab === "profile" && (
            <motion.div
              initial={{ opacity: 0, x: 8 }}
              animate={{ opacity: 1, x: 0 }}
              className="card p-6 space-y-5 mt-6"
            >
              <h3
                className="text-base font-semibold text-white"
                style={{ fontFamily: "DM Sans, sans-serif" }}
              ...
              <div className="space-y-2">
                {loading ? (
                  ...
                  departments.map((dept) => (
                    <div
                      key={dept.id}
                      className="flex items-center justify-between p-4 rounded-xl transition-smooth"
                      style={{
            ...
            <div className="p-6">
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter")
                      modal === "add" ? handleAddSubmit() : handleEditSubmit()
                  }}
                />
              </div>
              <div className="flex items-center justify-end gap-2">
                ...
                <button
                  type="button"
                  onClick={modal === "add" ? handleAddSubmit : handleEditSubmit}
                  className="btn btn-primary text-xs"
                >
