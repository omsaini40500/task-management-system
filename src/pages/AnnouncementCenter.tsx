    ...
    <div className="h-full flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: "#64748b" }}>
            Company-wide announcements, notices, banners, and events
          </p>
        </div>
        <button
      ...
      {showNew && (
        <div
          ...
          style={{ backgroundColor: "#1c2340", borderColor: "#6366f1" }}
        >
          ...
          <textarea
            ...
            rows={3}
            className="w-full rounded-lg px-4 py-2.5 text-sm border resize-none mb-4"
            style={{
              backgroundColor: "#0d1117",
              borderColor: "#252d4a",
              color: "#e2e8f0",
      ...
      <div className="flex gap-4 flex-1 min-h-0">
          ...
          {loading ? (
            ...
            announcements.map((a) => (
              <div
                ...
                style={{
                  backgroundColor:
                    selected?.id === a.id ? "rgba(99,102,241,0.1)" : "#1c2340",
              ...
              >
                <div className="flex items-start gap-2 mb-1">
                  ...
                  <span
                    ...
                    style={{
                      backgroundColor: `${typeColor[a.type] || "#6366f1"}22`,
                      color: typeColor[a.type] || "#6366f1",
                    }}
                  >
                    {a.type}
                  </span>
        ...
        <div
          className="flex-1 rounded-xl p-6 border overflow-auto"
          style={{ backgroundColor: "#1c2340", borderColor: "#252d4a" }}
        >
          {selected ? (
            <>
              <div className="flex items-start gap-3 mb-4">
                <span
                  ...
                  style={{
                    color: typeColor[selected.type] || "#6366f1",
                    backgroundColor: `${typeColor[selected.type] || "#6366f1"}22`,
                  }}
                >
                  {selected.type}
                </span>
              ...
              <p className="text-sm mb-6" style={{ color: "#64748b" }}>
                Posted by {selected.author} · {selected.date}
              </p>
              <p
