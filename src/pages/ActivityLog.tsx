    ...
    <div className="page">
      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm mt-0.5" style={{ color: "#6b7280" }}>
            Enterprise-grade audit trail for all system actions
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {[
          ...
          {
            label: "Active Users",
            value: new Set(logs.map((l) => l.userId)).size.toString(),
            color: "#8b5cf6",
          },
        ].map((s, i) => (
          <motion.div
            ...
            <thead>
              ...
              >
                {[
                  ...
                  <th
                    key={h}
                    className="text-left px-5 py-3 text-xs font-semibold uppercase tracking-widest whitespace-nowrap"
                    style={{
                      color: "#4b5563",
                ...
                filtered.map((log, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-5 py-3 text-sm text-white max-w-40 truncate">
                        {log.target}
                      </td>
                      <td className="px-5 py-3">
