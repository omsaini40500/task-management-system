...
import { Activity, Mail, Lock, Eye, EyeOff, ArrowRight, CheckCircle2, Key } from "lucide-react"
      ...
      <div className="relative z-10 w-full max-w-[440px] px-6 my-auto">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-white tracking-tight" style={{ fontFamily: "DM Sans, sans-serif" }}>
              Flash <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Agency</span>
            </h2>
            <p className="text-sm text-slate-400 mt-1.5 font-medium">High-Performance Workspace</p>
          </div>
          ...
          <div className="glass rounded-[28px] p-6 sm:p-8 md:p-10 shadow-[0_16px_64px_rgba(0,0,0,0.5)] border border-white/10 relative overflow-hidden">
            ...
            <AnimatePresence mode="wait">
              {step === "login" && (
                ...
                >
                  <div className="mb-8 text-center">
                    <h1 className="text-xl font-semibold text-white mb-2" style={{ fontFamily: "DM Sans, sans-serif" }}>Welcome back</h1>
                    ...
                    <div className="flex items-center justify-between pt-1">
                      <label className="flex items-center gap-2.5 cursor-pointer group">
                        <div className="relative flex items-center justify-center">
                          ...
                          />
                          <CheckCircle2 className="absolute w-3 h-3 text-white opacity-0 peer-checked:opacity-100 pointer-events-none" strokeWidth={3} />
                        </div>
                        <span className="text-sm text-slate-400 group-hover:text-slate-300 transition-colors select-none">Remember me</span>
                      </label>
                      <button 
                        type="button" 
                        onClick={() => { setStep("forgot"); setLoginError(null); }} 
              ...
              {step === "forgot" && (
                ...
                >
                  <div className="mb-8 text-center">
                    ...
                    <h1 className="text-xl font-semibold text-white mb-2" style={{ fontFamily: "DM Sans, sans-serif" }}>Reset Password</h1>
                    <p className="text-sm text-slate-400">Enter your email and we'll send instructions</p>
                  </div>
                  ...
                  {forgotSent ? (
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="text-center py-4">
                      ...
                      <button 
                        onClick={() => { setStep("login"); setForgotSent(false); forgotForm.reset(); }} 
                    ...
                    <form onSubmit={forgotForm.handleSubmit(handleForgotPassword)} className="space-y-5">
                      ...
                      >
                        <div className="relative flex items-center justify-center py-3.5">
                          {loading ? (
                            ...
                            <span className="font-medium text-white text-sm">Send Reset Link</span>
                          )}
                        </div>
                      </button>
                      ...
                      <button 
                        type="button" 
                        onClick={() => { setStep("login"); forgotForm.reset(); setForgotSent(false); }} 
              ...
              {step === "otp" && (
                ...
                >
                  <div className="mb-8 text-center">
                    <h1 className="text-xl font-semibold text-white mb-2" style={{ fontFamily: "DM Sans, sans-serif" }}>Two-step Verification</h1>
                    ...
                    {otp.map((digit, i) => (
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (!e.target.value && i > 0) (document.querySelectorAll(".otp-input")[i - 1] as HTMLInputElement)?.focus()
                        }}
                  ...
                  <button className="w-full relative group overflow-hidden rounded-xl bg-indigo-500 hover:bg-indigo-600 transition-all active:scale-[0.98] shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:shadow-[0_0_25px_rgba(99,102,241,0.5)]">
                    <div className="relative flex items-center justify-center py-3.5">
                      <span className="font-medium text-white text-sm">Verify & Continue</span>
                    </div>
                  </button>
